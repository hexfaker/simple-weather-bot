...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r simple_weather_bot/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg simple_weather_bot tests/**/*.py
